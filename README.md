...
The latest version: 5.1.6. Please use `Maven Central` link above to get the logger.
...
```groovy
dependencies {
    testImplementation 'com.epam.reportportal:logger-java-httpcomponents:5.1.6'
}
```
